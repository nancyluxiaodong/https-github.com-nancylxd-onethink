...
<body>
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		...
		<!--<div class="form-item">
			<label class="item-label">报修单号<span class="check-tips"></span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="sn" value="<?php echo ((isset($info["title"]) && ($info["title"] !== ""))?($info["title"]):''); ?>">
			</div>
		</div>-->
		<div class="form-item">
		...
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="sort" value="<?php echo ((isset($info["sort"]) && ($info["sort"] !== ""))?($info["sort"]):''); ?>">
			</div>
		</div>
		<!--<div class="form-item">
